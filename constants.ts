...
import { PracticesData, ModuleInfo, StarterStacksData, ModuleKey, SomaticPracticeType, PracticeTypeInfo, SomaticPreset, GroundingOption, NervousSystemCueType, GroundingModality, AffectTone } from './types.ts';
...
// Memory Reconsolidation Integration Options
// Curated list of practices compatible with belief shift and integration work
export const memoryReconsolidationIntegrationOptions = [
  {
    practiceId: 'coherent-breathing',
    practiceName: 'Coherent Breathing',
    category: 'nervous-system',
    description: 'Physiological regulation practice using 5.5-second breathing rhythm',
    bestFor: ['grounding', 'nervous-system-activation-reset', 'resource-building'],
  },
  {
    practiceId: 'physiological-sigh',
    practiceName: 'Physiological Sigh',
    category: 'nervous-system',
    description: 'Rapid stress relief through double inhale and extended exhale',
    bestFor: ['acute-anxiety', 'rapid-regulation', 'in-the-moment-support'],
  },
  {
    practiceId: 'microcosmic-orbit',
    practiceName: 'Microcosmic Orbit',
    category: 'subtle-body',
    description: 'Taoist energy circulation for internal balance and vitality',
    bestFor: ['integration', 'subtle-body-awareness', 'energetic-grounding'],
  },
  {
    practiceId: 'expressive-writing',
    practiceName: 'Expressive Writing',
    category: 'emotional-processing',
    description: 'Narrative processing of difficult experiences and emotions',
    bestFor: ['emotional-release', 'meaning-making', 'integration-anchoring'],
  },
  {
    practiceId: 'perspective-taking',
    practiceName: 'Perspective Taking',
    category: 'cognitive-reframe',
    description: 'Deliberate adoption of alternative viewpoints',
    bestFor: ['belief-flexibility', 'cognitive-shift', 'relational-awareness'],
  },
  {
    practiceId: 'belief-examination',
    practiceName: 'Examining Core Beliefs',
    category: 'cognitive-reframe',
    description: 'Deep inquiry into limiting beliefs and empowering alternatives',
    bestFor: ['belief-examination', 'worldview-update', 'identity-work'],
  },
  {
    practiceId: 'body-scan-meditation',
    practiceName: 'Body Scan Meditation',
    category: 'somatic-awareness',
    description: 'Systematic awareness of bodily sensations and tension',
    bestFor: ['somatic-integration', 'embodied-awareness', 'trauma-informed-support'],
  },
  {
    practiceId: 'loving-kindness',
    practiceName: 'Loving-Kindness Meditation',
    category: 'compassion-practices',
    description: 'Cultivation of unconditional friendliness and compassion',
    bestFor: ['self-compassion', 'shame-resilience', 'relational-shift'],
  },
  {
    practiceId: 'self-compassion',
    practiceName: 'Self-Compassion Practice',
    category: 'compassion-practices',
    description: 'Three-part practice for self-directed care during difficulty',
    bestFor: ['shame-resilience', 'emotional-balance', 'growth-integration'],
  },
  {
    practiceId: 'somatic-tapping',
    practiceName: 'Somatic Tapping (EFT-inspired)',
    category: 'somatic-release',
    description: 'Gentle tapping on meridian points to release emotional charge',
    bestFor: ['emotional-release', 'nervous-system-reset', 'embodied-processing'],
  },
  {
    practiceId: 'grounding-5-4-3-2-1',
    practiceName: '5-4-3-2-1 Grounding Technique',
    category: 'grounding',
    description: 'Sensory anchoring to present moment via five senses',
    bestFor: ['dissociation-support', 'anxiety-management', 'present-moment-anchoring'],
  },
  {
    practiceId: 'vagus-nerve-toning',
    practiceName: 'Vagus Nerve Toning',
    category: 'parasympathetic-activation',
    description: 'Humming, gargling, or gentle massage to activate vagal tone',
    bestFor: ['parasympathetic-activation', 'nervous-system-resilience', 'vagal-safety'],
  },
  {
    practiceId: 'pendulum-awareness',
    practiceName: 'Pendulum Awareness (Somatic Experiencing)',
    category: 'somatic-processing',
    description: 'Gentle oscillation between activation and calm for titration',
    bestFor: ['trauma-titration', 'nervous-system-flexibility', 'embodied-resilience'],
  },
  {
    practiceId: 'embodied-movement',
    practiceName: 'Free Movement/Dance',
    category: 'embodied-expression',
    description: 'Expressive movement to process and integrate emotional energy',
    bestFor: ['emotional-expression', 'embodied-integration', 'activation-discharge'],
  },
  {
    practiceId: 'bilateral-stimulation',
    practiceName: 'Bilateral Stimulation Awareness',
    category: 'processing-support',
    description: 'Alternating stimulation to support information processing',
    bestFor: ['emotional-processing', 'trauma-processing', 'integration-support'],
  },
  {
    practiceId: 'inner-safe-place',
    practiceName: 'Inner Safe Place Visualization',
    category: 'imaginal-resource',
    description: 'Guided creation of an internal resource space',
    bestFor: ['resource-activation', 'nervous-system-safety', 'resilience-building'],
  },
  {
    practiceId: 'self-guided-shadow-work',
    practiceName: 'Self-Guided Shadow Work',
    category: 'self-inquiry',
    description: 'Personal reflection on disowned aspects of self',
    bestFor: ['belief-examination', 'shadow-integration', 'identity-expansion'],
  },
];

// Grounding Options for Memory Reconsolidation Sessions
// Pre-configured grounding resources for nervous system support during belief work
export const memoryReconsolidationGroundingOptions: GroundingOption[] = [
  {
    id: 'grounding-5-4-3-2-1',
    name: '5-4-3-2-1 Sensory Grounding',
    modality: 'environmental',
    description: 'Anchor to the present moment by noticing 5 things you see, 4 you hear, 3 you feel, 2 you smell, 1 you taste.',
    duration: 180,
    instructions: [
      'Find a comfortable, safe position.',
      'Notice 5 things you can see around you. Look at them closely.',
      'Listen for 4 sounds you can hear. What are they?',
      'Notice 3 things you can physically feel (texture, temperature, pressure).',
      'Identify 2 things you can smell (even faint scents).',
      'Notice 1 thing you can taste.',
      'Take a full breath and return your attention to the present.',
    ],
    cueType: 'grounding',
    supportedAffects: ['fear', 'confusion', 'mixed', 'neutral'],
  },
  {
    id: 'grounding-vagus-tapping',
    name: 'Vagus Tapping',
    modality: 'somatic',
    description: 'Gentle tapping on the vagus nerve pathway to activate parasympathetic response.',
    duration: 120,
    instructions: [
      'Sit comfortably and place your fingers on your neck, just below the ear.',
      'Gently tap along the path from your jaw to your collarbone (vagus pathway).',
      'Use moderate pressure with a rhythmic tapping (about 1 tap per second).',
      'Continue for 60-120 seconds while taking slow, deep breaths.',
      'Notice any shifts in your nervous system—ease, relaxation, settling.',
    ],
    cueType: 'body-sensation',
    supportedAffects: ['fear', 'anger', 'mixed', 'neutral'],
  },
  {
    id: 'grounding-safe-place',
    name: 'Inner Safe Place Visualization',
    modality: 'cognitive',
    description: 'Imaginative resource: a place where you feel completely safe and resourced.',
    duration: 300,
    instructions: [
      'Find a quiet place to sit or lie down.',
      'Close your eyes and think of a place where you feel completely safe—real or imagined.',
      'Engage all senses: What do you see? Hear? Feel? Smell?',
      'Add details: colors, textures, temperature, sounds, even scents.',
      'Spend time there, feeling the safety and relaxation.',
      'You can return to this place any time you need grounding.',
    ],
    cueType: 'grounding',
    supportedAffects: ['fear', 'shame', 'sadness', 'grief'],
  },
  {
    id: 'grounding-breath-box',
    name: 'Box Breathing (4-4-4-4)',
    modality: 'breath',
    description: 'Structured breathing pattern: inhale for 4, hold for 4, exhale for 4, hold for 4.',
    duration: 240,
    instructions: [
      ...
      'Repeat this cycle 6-10 times (total: 4-6 minutes).',
      'Feel your nervous system gradually calm and regulate.',
    ],
    cueType: 'breath',
    supportedAffects: ['fear', 'confusion', 'mixed', 'neutral'],
  },
  {
    id: 'grounding-progressive-relaxation',
    name: 'Progressive Muscle Relaxation',
    modality: 'somatic',
    description: 'Systematic tensing and releasing of muscle groups to discharge activation.',
    duration: 600,
    instructions: [
      'Lie down or sit comfortably.',
      'Starting with your feet, tense muscles for 5 seconds, then release.',
      'Move progressively up through your legs, torso, arms, shoulders, and face.',
      'Notice the contrast between tension and relaxation.',
      'After completing all groups, rest in the relaxed state for a few minutes.',
      'This practice discharges nervous system activation and builds body awareness.',
    ],
    cueType: 'body-sensation',
    supportedAffects: ['anger', 'confusion', 'mixed', 'neutral'],
  },
  {
    id: 'grounding-pendulum',
    name: 'Pendulum Awareness (Gentle Oscillation)',
    modality: 'somatic',
    description: 'Titration through gentle rocking or self-holding to find nervous system balance.',
    duration: 300,
    instructions: [
      'Sit comfortably or stand with feet hip-width apart.',
      'Begin to gently sway side-to-side or rock forward and back.',
      'Move slowly, noticing any sense of activation or calm.',
      'Find a pace that feels regulating—not too fast, not too slow.',
      'Continue for 5-10 minutes, allowing your nervous system to find its window of tolerance.',
      'Notice how your body feels more settled.',
    ],
    cueType: 'body-sensation',
    supportedAffects: ['confusion', 'mixed', 'fear', 'sadness'],
  },
  {
    id: 'grounding-humming',
    name: 'Humming/Toning Vagal Activation',
    modality: 'sound',
    description: 'Vocalization to stimulate the vagus nerve and activate parasympathetic tone.',
    duration: 180,
    instructions: [
      'Sit comfortably and take a deep breath.',
      'On the exhale, produce a steady humming sound (like "mmmmm").',
      'Feel the vibration in your chest, face, and head.',
      'Continue for 8-12 exhales at your own pace.',
      'Notice the calming, settling effect of the vibration and sound.',
      'You can hum a simple melody or just sustain the tone.',
    ],
    cueType: 'sound',
    supportedAffects: ['anger', 'confusion', 'mixed', 'neutral'],
  },
  {
    id: 'grounding-earth-connection',
    name: 'Grounding to Earth (Barefoot Connection)',
    modality: 'environmental',
    description: 'Direct contact with earth to experience grounding and energy exchange.',
    duration: 600,
    instructions: [
      'Find a natural outdoor space (grass, soil, sand, or natural surface).',
      'Remove your shoes and socks.',
      'Stand barefoot and feel your feet making contact with the earth.',
      'Notice the temperature, texture, and connection.',
      'Spend 10-20 minutes standing, sitting, or walking barefoot.',
      'Imagine drawing stability and calm up through your feet.',
    ],
    cueType: 'grounding',
    supportedAffects: ['fear', 'confusion', 'mixed', 'neutral'],
  },
  {
    id: 'grounding-hand-heart',
    name: 'Hand-to-Heart Somatic Anchor',
    modality: 'somatic',
    description: 'Bilateral self-soothing through hand placement and gentle pressure.',
    duration: 300,
    instructions: [
      'Place one or both hands over your heart.',
      'Feel your heartbeat or simply the warmth of your hands.',
      'Take slow, deep breaths.',
      'You might add a gentle swaying motion.',
      'Internally say something compassionate: "I am safe," "This will pass," or similar.',
      'Continue for 5-10 minutes as needed.',
    ],
    cueType: 'body-sensation',
    supportedAffects: ['shame', 'grief', 'sadness', 'fear'],
  },
];